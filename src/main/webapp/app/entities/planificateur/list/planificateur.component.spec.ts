...
import { sampleWithRequiredData } from '../planificateur.test-samples';
...
describe('Planificateur Management Component', () => {
  let comp: PlanificateurComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PlanificateurComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.planificateurs()[0]).toEqual(expect.objectContaining({ id: 18052 }));
  });

  describe('trackId', () => {
    it('Should forward to planificateurService', () => {
      const entity = { id: 18052 };
      jest.spyOn(service, 'getPlanificateurIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPlanificateurIdentifier).toHaveBeenCalledWith(entity);
