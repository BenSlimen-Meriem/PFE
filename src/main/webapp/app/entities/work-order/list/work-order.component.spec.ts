...
import { sampleWithRequiredData } from '../work-order.test-samples';
...
describe('WorkOrder Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.workOrders()[0]).toEqual(expect.objectContaining({ id: 28118 }));
  });

  describe('trackId', () => {
    it('Should forward to workOrderService', () => {
      const entity = { id: 28118 };
      jest.spyOn(service, 'getWorkOrderIdentifier');
      const id = comp.trackId(entity);
      expect(service.getWorkOrderIdentifier).toHaveBeenCalledWith(entity);
