...
import { sampleWithRequiredData } from '../motif.test-samples';
...
describe('Motif Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.motifs()[0]).toEqual(expect.objectContaining({ id: 24185 }));
  });

  describe('trackId', () => {
    it('Should forward to motifService', () => {
      const entity = { id: 24185 };
      jest.spyOn(service, 'getMotifIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMotifIdentifier).toHaveBeenCalledWith(entity);
