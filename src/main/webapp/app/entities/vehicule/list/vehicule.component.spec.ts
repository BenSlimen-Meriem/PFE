...
import { sampleWithRequiredData } from '../vehicule.test-samples';
...
describe('Vehicule Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.vehicules()[0]).toEqual(expect.objectContaining({ id: 32197 }));
  });

  describe('trackId', () => {
    it('Should forward to vehiculeService', () => {
      const entity = { id: 32197 };
      jest.spyOn(service, 'getVehiculeIdentifier');
      const id = comp.trackId(entity);
      expect(service.getVehiculeIdentifier).toHaveBeenCalledWith(entity);
