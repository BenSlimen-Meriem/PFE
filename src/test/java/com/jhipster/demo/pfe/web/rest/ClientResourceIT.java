...
import static com.jhipster.demo.pfe.domain.ClientAsserts.*;
...
class ClientResourceIT {
    ...
    public static Client createEntity() {
        return new Client().raisonSociale(DEFAULT_RAISON_SOCIALE).identifiantUnique(DEFAULT_IDENTIFIANT_UNIQUE);
    }
    ...
    public static Client createUpdatedEntity() {
        return new Client().raisonSociale(UPDATED_RAISON_SOCIALE).identifiantUnique(UPDATED_IDENTIFIANT_UNIQUE);
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.raisonSociale(UPDATED_RAISON_SOCIALE).identifiantUnique(UPDATED_IDENTIFIANT_UNIQUE);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.raisonSociale(UPDATED_RAISON_SOCIALE).identifiantUnique(UPDATED_IDENTIFIANT_UNIQUE);
