...
import com.jhipster.demo.pfe.service.EmployeeService;
...
/**
 * REST controller for managing {@link com.jhipster.demo.pfe.domain.Employee}.
 */
@RestController
...
public class EmployeeResource {
    ...
    public ResponseEntity<List<Employee>> getAllEmployees(
        ...
        if ("executeur-is-null".equals(filter)) {
            LOG.debug("REST request to get all Employees where executeur is null");
            return new ResponseEntity<>(employeeService.findAllWhereExecuteurIsNull(), HttpStatus.OK);
        }

        if ("planificateur-is-null".equals(filter)) {
            LOG.debug("REST request to get all Employees where planificateur is null");
            return new ResponseEntity<>(employeeService.findAllWherePlanificateurIsNull(), HttpStatus.OK);
        }
