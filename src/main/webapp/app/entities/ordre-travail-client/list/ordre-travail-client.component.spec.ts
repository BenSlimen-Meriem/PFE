...
import { sampleWithRequiredData } from '../ordre-travail-client.test-samples';
...
describe('OrdreTravailClient Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [OrdreTravailClientComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ordreTravailClients()[0]).toEqual(expect.objectContaining({ id: 24849 }));
  });

  describe('trackId', () => {
    it('Should forward to ordreTravailClientService', () => {
      const entity = { id: 24849 };
      jest.spyOn(service, 'getOrdreTravailClientIdentifier');
      const id = comp.trackId(entity);
      expect(service.getOrdreTravailClientIdentifier).toHaveBeenCalledWith(entity);
