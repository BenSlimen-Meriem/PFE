...
/**
 * Service Implementation for managing {@link com.jhipster.demo.pfe.domain.Client}.
 */
@Service
@Transactional
    ...
    public Optional<Client> partialUpdate(Client client) {
        ...
        return clientRepository
            ...
            .map(existingClient -> {
                ...
                if (client.getIdentifiantUnique() != null) {
                    existingClient.setIdentifiantUnique(client.getIdentifiantUnique());
                }
